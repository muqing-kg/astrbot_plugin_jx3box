...
def render_help_image(out_path: str | Path) -> str:
    ...
    lines = [
        ...
        ("", font_body, "#000"),
        ("赤兔", font_h, "#0B7285"),
        ("/赤兔订阅 区服名", font_body, "#222"),
        ("示例：/赤兔订阅 梦江南", font_body, "#555"),
        ("/赤兔查询（管理员）", font_body, "#222"),
        ("/赤兔删除 序号（管理员）", font_body, "#222"),
        ("", font_body, "#000"),
        ("提示：查不到会提示名称错误", font_body, "#777"),
        ("候选图每页最多 100 条，可换页继续", font_body, "#777"),
        ("一个群可订阅多个区服，推送不串群", font_body, "#777"),
    ]
    pad = 40
    width = 720
