...
def render_help_image(out_path: str | Path) -> str:
    ...
    lines = [
        ...
        ("", font_body, "#000"),
        ("物品", font_h, "#0B7285"),
        ("物品查询 关键词", font_body, "#222"),
        ("示例：物品查询 玄晶", font_body, "#555"),
        ("多个结果直接回复数字选择", font_body, "#555"),
        ("超过 10 条出图，回复 换页 翻页", font_body, "#555"),
        ("", font_body, "#000"),
        ("成就", font_h, "#0B7285"),
        ("成就查询 关键词", font_body, "#222"),
        ("示例：成就查询 武神重临", font_body, "#555"),
        ("返回成就链接", font_body, "#555"),
        ("", font_body, "#000"),
        ("任务", font_h, "#0B7285"),
        ("任务查询 关键词", font_body, "#222"),
        ("示例：任务查询 茶馆问讯", font_body, "#555"),
        ("返回任务信息卡", font_body, "#555"),
        ("", font_body, "#000"),
        ("提示：命令带不带 / 均可", font_body, "#777"),
        ("查不到会提示名称错误", font_body, "#777"),
        ("候选图每页最多 100 条，可换页继续", font_body, "#777"),
    ]
    pad = 40
    width = 720
